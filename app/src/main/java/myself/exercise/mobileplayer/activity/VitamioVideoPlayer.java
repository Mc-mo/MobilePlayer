...
import myself.exercise.mobileplayer.view.VitamioVideoView;
...
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Vitamio.isInitialized(VitamioVideoPlayer.this);
    ...
    private void initData() {
         ...
         * 实现手势识别器 并重写长按 单击和双击
         */
        mDetector = new GestureDetector(VitamioVideoPlayer.this, new GestureDetector
    ...
    private void initView() {
        mVideoView = (VitamioVideoView) findViewById(R.id.videoview);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case NET_SPEED:
                    ...
                    String net_speed = mUtils.getNetSpeed(VitamioVideoPlayer.this);
                ...
                case PROGRESS:
                    int current_time = (int) mVideoView.getCurrentPosition();
                    ...
                    //自定义判断卡不卡
                    if (!isSystemBuff && mVideoView.isPlaying()) {
    ...
    private void showSwitchDialog() {
        ...
        buidler.setTitle("提示");
        buidler.setMessage("当播放视频的时候出现花屏时您可以选择切换系统播放器");
...
//            Toast.makeText(VitamioVideoPlayer.this, "无法播放该视频", Toast.LENGTH_SHORT).show();
            showErrorDialog();
            return true;
        }
    }
    ...
    class myOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            btn_video_start_pause.setBackgroundResource(R.drawable
                    .btn_video_pause_selector);
            mVideoView.start();
            int duration_time = (int) mVideoView.getDuration();
            //设置progressbar总时长
